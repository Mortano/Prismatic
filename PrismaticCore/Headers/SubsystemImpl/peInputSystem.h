...
public:
    ...
    peVector2f                              GetMouseDelta() const override;
    KeyState                                GetMouseButtonState(MouseButton mouseButton) const override;
    const peDelegate<KeyCode_t, KeyState>&   GetKeyEvent() const override { return _keyEvent; }
    const peDelegate<MouseButton, KeyState>& GetMouseEvent() const override { return _mouseEvent; }
